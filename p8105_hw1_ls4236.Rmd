...
This helps explain why `mean` functions works on logical vector (proportion of TRUEs), fails on character vector, and sometimes fails to produce results on factor vector. Even if it successfully produce results on factor vector, it still has little statistical interpretations.
